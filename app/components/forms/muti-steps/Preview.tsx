            ...
            {(["overview", "included"] as TabType[]).map((tab) => (
              <button
                ...
                className={`pb-3 capitalize transition-all relative font-bold text-lg ${
                  activeTab === tab
                    ? "text-[#29b6be] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-[#29b6be]"
          ...
          <div className="pt-2">
            {activeTab === "overview" ? (
              <div className="space-y-6 animate-in fade-in duration-300">
                <div className="space-y-2">
                  <h2 className="text-lg font-bold text-[#212B36]">Overview</h2>
                  <p className="text-[#637381] mt-4 text-md">
                    {dealDetails?.shortDescription}
                  </p>
                </div>

                <div className="space-y-3 pt-2">
                  <h3 className="text-md font-bold text-[#31BFC8] tracking-tight">
                    Highlights
                  </h3>
              ...
              <div className="animate-in fade-in duration-300">
                <div className="space-y-8">
                  <div>
                    <h1 className="text-md font-bold text-[#212B36]">
                      What You&apos;ll Experience
                    </h1>
                    <p className="text-[#637381] text-md mt-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    {/* Included Column */}
                    {parsePoints(overview?.includedPoints || [])?.length >
                      0 && (
                      <div className="space-y-4 bg-gray-50 rounded-lg p-4">
                        <h4 className="text-lg font-bold text-[#31BFC8] tracking-tight ">
                          What&apos;s Included
                        </h4>

                        <ul className="space-y-3.5  text-slate-600">
                          {parsePoints(overview?.includedPoints || [])?.map(
                            (item, index) => (
                              <li
                                key={`inc-${index}`}
                    ...
                    {/* Not Included Column */}
                    {parsePoints(overview?.notIncludedPoints || [])?.length >
                      0 && (
                      <div className="space-y-4 bg-gray-200 rounded-lg p-4">
                        <h4 className="text-lg font-bold text-black tracking-tight pb-2 ">
                          What&apos;s Not Included
                        </h4>

                        <ul className="space-y-3.5  text-slate-600">
                          {parsePoints(overview?.notIncludedPoints || [])?.map(
                            (item, index) => (
                              <li
                                key={`not-${index}`}
